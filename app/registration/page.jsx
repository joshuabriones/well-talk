...
const Registration = () => {
  ...
  return (
                          ...
                          <div className="flex flex-col">
                            ...
                            <div className="flex items-center mt-1">
                              <input
                                type="checkbox"
                                id="useAsCurrent"
                                checked={useAsCurrent}
                                onChange={handleCheckboxChange}
                                className="mr-1 h-3 w-3 text-black focus:ring-black border-gray-300 rounded"
                              />
                              <label htmlFor="useAsCurrent" className="text-xs">
                                Use this as current address
                              </label>
                            </div>
                          </div>
    ...
    peer-focus:top-0 dark:bg-black`}
            ...
            {showTerms && <TermsAndCondition onClose={handleCloseModal} />}
          </div>
