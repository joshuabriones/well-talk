  ...
  return (
    <div className="w-full h-full flex justify-center">
      <main>
        ...
        >
          <div className="py-48 xl:px-96 text-center">
            ...
            <p className="text-2xl sm:text-3xl lg:text-4xl xl:px-40 py-10 mb-8 text-stone-700 font-Jaldi">
              Your Campus Mental Wellness Hub: Connect with Counselors, Access
              Resources, and Build a Supportive Community for Mental Health
            </p>
            <div className="w-full flex flex-row gap-x-8 pb-12">
              <HollowButton className="w-1/2" onClick={handleSignInClick}>
                Sign In
              </HollowButton>
              <FullButton className="w-1/2" onClick={handleCreateAccountClick}>
                Create Account
              </FullButton>
            </div>
          </div>
        ...
        <section id="featured" className="container mx-auto px-5 lg:px-0">
