  ...
  return (
    <div className="w-full h-screen flex flex-col items-center justify-center">
      <main className="min-h-screen">
        ...
        <div className="flex justify-between items-center px-44 pt-24">
        ...
        <div className="flex container mx-auto mt-20">
          <div className="w-1/2">
            <div className="p-5 mt-40">
              ...
              <p>
                Meet the compassionate individuals who form the backbone of{" "}
                <br></br> our counseling team. Each counselor brings a wealth of
                expertise<br></br> and empathy, ready to guide you through
                life's challenges with<br></br> understanding and support.
              </p>
            </div>
          </div>
          <div className="w-1/2">
