  ...
  <table className="w-full table-auto">
    ...
    <tbody>
      {currentAppointments?.map((appointment) => (
        ...
        >
          <td className="text-center py-2">{appointment.appointmentId}</td>
          <td>
            <div className="text-sm">{formatDate(appointment.appointmentDate)}</div>
          </td>
          <td className="py-2">{appointment.appointmentStartTime}</td>
          <td>{appointment.appointmentType}</td>
          <td>
            <p className="truncate">
              {appointment.appointmentPurpose.length > 50
                ? `${appointment.appointmentPurpose.substring(0, 40)}...`
