...
const StudentJournal = () => {
	...
	const handleEntryClick = () => {
		// This function is called when a journal entry is clicked
		setShowEntry(true);
	};
		...
		<div className="min-h-screen">
			...
			<div className="h-screen w-full font-Merriweather">
				<div className="w-full h-full pt-24 pb-14 px-4 md:px-8 lg:px-32 flex flex-col lg:flex-row">
					{/* List */}
					<section className="w-full lg:w-1/3 h-full py-3 overflow-y-auto">
						<button
							className="z-10 tooltip tooltip-success w-full md:w-11/12 lg:w-11/12 mb-4 py-2 rounded-2xl bg-maroon flex items-center justify-center gap-2"
					...
					{showEntry && ( // Render the section only if showEntry is true
						<section className="w-full lg:w-2/3 h-full md:h-full lg:h-full pb-20 px-4 md:px-8 lg:px-16 rounded-2xl border-2 shadow-2xl relative">
							{/* Buttons */}
							...
							<div className="w-full h-full flex flex-col overflow-y-auto p-5">
								...
								{/* Dates Section */}
								<div className="flex-none mb-8 font-Jaldi text-s italic text-gray-600">
