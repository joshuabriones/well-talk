				...
				<div className="relative z-10 flex items-center justify-center h-full">
					<div className="flex flex-col text-left px-44 py-10 gap-y-4">
						...
						<p className="w-1/2 font-Jaldi text-xl">
							Facilitate student inquiries and foster meaningful connections with
			...
			<div className="flex flex-col text-center">
				...
				<div className="overflow-x-auto px-56 py-10 ">
					<table className="table bg-gray-100">
						...
						<thead>
							<tr className="bg-gray-200 font-bold">
								...
								{/* Delete and Edit*/}
								<th className="no-hover-highlight" style={{ width: "10%" }}></th>
							</tr>
						</thead>
						<tbody>
					...
					<div className="join pt-5">
						...
						{inquiries &&
							[...Array(Math.ceil((inquiries?.length || 1) / inquiriesPerPage))].map(
								(_, index) => (
									<button
										key={index}
