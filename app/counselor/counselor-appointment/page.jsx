...
export default function Appointment() {
	...
	const fetchAppointments = async () => {
		...
		if (isPendingTable) {
			setAppointments(
				retrievedAppointments.filter((appointment) => appointment.status === "Pending")
			);
		} else {
			setAppointments(
	...
	const currentAppointments1 = appointments?.slice(indexOfFirstInquiry1, indexOfLastInquiry1);
