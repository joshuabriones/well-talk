...
const DashboardIcon = () => {
  return (
    <svg
      ...
      height="24"
      viewBox="0 0 24 24"
      className="group group-hover:text-white group-hover:scale-110 transition-transform duration-300 ease-in-out"
    ...
    >
      <path
        ...
        className="group-hover:fill-white fill-navgray"
      />
    </svg>
  );
};
