...
export const registrationSchema = z
  .object({
    email: z
      ...
      .refine((email) => email.endsWith("@cit.edu"), {
        message: "Email must end with '@cit.edu'",
      }),
    idno: z
...
export const studentSchema = z.object({
  ...
  parentGuardianName: z.string().nonempty("Guardian Name is required"),
  parentGuardianContactNumber: z
    .string()
