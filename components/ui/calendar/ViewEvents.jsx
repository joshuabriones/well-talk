import { faClock, faPen, faXmark } from "@fortawesome/free-solid-svg-icons";
			...
			<div className="view-modal" ref={domNode}>
				...
				<div className="event-modal-content">
						...
						<div className="title-container">
							<div className="title-design">
								<span
									...
									style={{ backgroundColor: `${selectedEvent.label}` }}
								></span>
							</div>
					...
					{selectedEvent.startTime && (
						<div className="event-scheduling-detail" style={{ marginBottom: "15px" }}>
							<FontAwesomeIcon
								icon={faClock}
								className="schedule-icon"
							></FontAwesomeIcon>
							<div className="view-event-time">
								{moment(selectedEvent.startTime).format("dddd")},{" "}
								{moment(selectedEvent.startTime).format("MMMM")}{" "}
								{moment(selectedEvent.startTime).format("D")}{" "}
								{moment(selectedEvent.startTime).format("hh:mm")} -{" "}
								{moment(selectedEvent.endTime).format("hh:mma")}
							</div>
						</div>
					)}
					{selectedEvent.addDescription && (
