	...
	return (
		<div>
			<ScrollAnimationWrapper animationType="fadeInFromLeft">
				<div className="mb-12 bg-maroon border-t-2 border-b-2 border-zinc-900 dark:border-white">
						...
						<div className="w-full mx-auto items-center">
							<div className="max-w-xl mb-10 md:mx-auto sm:text-center lg:max-w-2xl md:mb-12">
								...
								<p className="text-base text-white font-Jaldi md:text-lg">
									Our simplified process ensures you can
									easily book appointments with our
									counselors. Follow these steps to get
									started on your journey towards better
							...
							<div className="grid max-w-screen-lg gap-20 lg:grid-cols-2 sm:mx-auto">
									...
									<div className="flex">
										...
										<div>
											<h6 className="mb-2 font-semibold font-Merriweather text-white leading-5">
												Step 1: Enter Appointment
												Details
											</h6>
											<p className="text-sm text-white font-Jaldi">
												Start by entering the purpose of
												your appointment and any
												additional notes you want to
												include.
											</p>
									...
									<div className="flex">
										...
										<div>
											...
											<p className="text-sm text-white font-Jaldi">
												...
												appointment. Available slots are
												from <b>8 am to 5 pm</b>.
												Unavailable slots will be grayed
												out.
											</p>
											<hr className="w-full my-6 border-silver" />
										</div>
									...
									<div className="flex">
										...
										<div>
											...
											<p className="text-sm text-white font-Jaldi">
												...
												counselors will be assigned
												based on availability; you
												cannot choose a specific
												counselor.
											</p>
										</div>
									</div>
								...
								<div className="flex items-center justify-center -mx-4 lg:pl-8">
									<div className="flex flex-col items-end px-3">
										<img
											className={`object-cover mb-6 rounded shadow-lg h-28 sm:h-48 xl:h-56 w-28 sm:w-48 xl:w-56 ${styles.floating}`}
