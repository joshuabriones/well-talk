        ...
        <div className="lg:w-2/5">
          <ScrollAnimationWrapper animationType="default">
            ...
            <p className="font-Jaldi text-gray-700 mt-4">
              Seamlessly connect with counselors and peers. Whether you're
              seeking guidance, support, or simply a listening ear, WellTalk
              fosters meaningful conversations that promote well-being and
              personal growth.
            </p>
        ...
        <div className="md:w-4/5 lg:w-4/5 mt-12 lg:mt-0">
          <ul className="grid gap-8 sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-2 xl:grid-cols-2">
            {features.map((item, idx) => (
              <ScrollAnimationWrapper animationType="default" key={idx}>
          ...
          <div className="bg-gold rounded-xl h-auto">
            ...
            <div className="bg-gold rounded-b-xl p-4 md:px-8 md:pb-8 lg:px-8 lg:pb-8">
              ...
              <p className="mt-6 text-lg md:text-xl lg:text-xl text-gray-600 text-justify text-center font-Jaldi">
                The CIT University Guidance Center aims for the holistic
                development of our dear Technologians. The office is committed
                to promulgating services in shaping students to reach their full
                potential. With that in mind, check out our Mission, Vision, and
                Guidance services that you can avail!
              </p>
            </div>
          </div>
        </div>
