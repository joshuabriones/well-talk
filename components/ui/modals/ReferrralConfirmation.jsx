...
const ReferralConfirmation = (
	...
	return (
		<>
			<input type="checkbox" id="my_modal_8" className="modal-toggle" checked={true} />
			<div className="modal" role="dialog">
				<div className="modal-box p-9 text-center">
					...
					/>
					<h3 className="text-xl font-bold py-2">Registration Successful</h3>
					<p className="text-sm py-4">
						Registration has been successful. You may now proceed to login page!{" "}
						{/* to be deleted */}
					</p>
					{/* <FullButton onClick={handleLoginClick}>Go to Login</FullButton> */}
				</div>
				<label
