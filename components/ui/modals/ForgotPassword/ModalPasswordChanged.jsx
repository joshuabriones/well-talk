          ...
          <div className="p-10 flex flex-col">
            <div className="flex flex-col gap-y-2.5">
              ...
              <p className="font-Jaldi text-lg mt-6 ">
                Your account is now updated with your new password. Your
                security is our priority, so feel confident in your enhanced
                protection. Carry on accessing our services worry-free with your
                updated credentials.
              </p>
            </div>
